...
export default function HomePage({ onNavigate }) {
  ...
  return (
    <>
        ...
        <div className="hero-left">
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <p className="hero-body stagger-3">
              Nexus gives legal teams the precision instruments to draft, track, approve and close contracts —
        ...
        <div className="hero-right">
          <div className="hero-right-top">
            <div className="contract-visual">
              ...
              <div className="cv-party">TechCorp Inc. &nbsp;×&nbsp; Nexus Client Co.</div>
      ...
      {/* FEATURES */}
      <div className="section-divider reveal" ref={addRevealRef}>
        <div className="sd-label">Why Nexus</div>
        <div className="sd-line"></div>
      ...
      <div className="features-section">
        <div className="features-intro reveal" ref={addRevealRef}>
          ...
          <p className="fi-body">Most CLM tools bury you in features. Nexus surfaces exactly what needs your attention
            — and nothing else.</p>
      ...
      <footer className="footer">
        <div className="footer-left">
          <div className="footer-brand">Nexus<sup style={{ fontFamily: 'var(--f-mono)', fontSize: '9px', color: 'var(--faint)' }}>CLM</sup></div>
          <div className="footer-copy">© 2026 Nexus Technologies Inc.</div>
        </div>
